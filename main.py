...
def mining_ctrel(root: str, name: str,):
    ...
    print("starting mining cross-time inversion...")
    ct_invs = []
    ...
    export2file(ct_invs, graph.home + "/ct_invs.txt")
    
    
    # checking for ct hierarchy
    print("starting mining cross-time hierarchy...")
    ct_hierarchy = []
    for rel1 in graph.relations:
        for rel2 in graph.relations:
            if rel1 != rel2:
    ...
    export2file(ct_hierarchy, graph.home + "/ct_hierarchy.txt")
    
    
    # checking for intersection
    print("starting mining cross-time intersection...")
    intersection = []
    for rel1 in graph.relations:
        for rel2 in graph.relations:
    ...
    export2file(intersection, graph.home + "/ct_intersection.txt")
    
    
    # checking for composition
    print("starting mining cross-time composition...")
    comps = []
    for rel1 in graph.relations:
        for rel2 in graph.relations:
            for rel3 in graph.relations:
    ...
    export2file(comps, graph.home + "/ct_comps.txt")
...
def mining_simurel(root: str, name: str):
    ...
    invs = list(set(invs))
    export2file(invs, graph.home + "/invs.txt")

    # checking for composition
    print("starting mining composition...")
    comps = []
    for rel1 in graph.relations:
        for rel2 in graph.relations:
            for rel3 in graph.relations:
    ...
    comps = list(set(comps))
    export2file(comps, graph.home + "/comps.txt")
